...
import gui.application.CustomStringConverter;
...
public class HistogramController implements Serializable
{
    ...
    private transient XYChart.Series data = new XYChart.Series();
    private transient XYChart.Data d1 = new XYChart.Data( "2.0", 0 );
    private transient XYChart.Data d2 = new XYChart.Data( "3.0", 0 );
    private transient XYChart.Data d3 = new XYChart.Data( "3.5", 0 );
    private transient XYChart.Data d4 = new XYChart.Data( "4.0", 0 );
    private transient XYChart.Data d5 = new XYChart.Data( "4.5", 0 );
    private transient XYChart.Data d6 = new XYChart.Data( "5.0", 0 );
    public transient int mark2_0 = 0, mark3_0 = 0, mark3_5 = 0, mark4_0 = 0, mark4_5 = 0, mark5_0 = 0;

    @FXML transient NumberAxis yAxis;
    @FXML transient BarChart<String, Number> markChart;
